    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
            {
                ...
                float _Absolute_47687D69_Out_1;
                Unity_Absolute_float(_Split_C4B2F888_G_2, _Absolute_47687D69_Out_1);
                float _Clamp_7DFFA574_Out_3;
                Unity_Clamp_float(_Absolute_47687D69_Out_1, 0, 1, _Clamp_7DFFA574_Out_3);
                ...
                float _Absolute_A4D565CD_Out_1;
                Unity_Absolute_float(_Split_7AAAB3D7_G_2, _Absolute_A4D565CD_Out_1);
                float _Clamp_8F67BD3C_Out_3;
                Unity_Clamp_float(_Absolute_A4D565CD_Out_1, 0, 1, _Clamp_8F67BD3C_Out_3);
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float3 _SceneColor_E03F9940_Out_1;
                Unity_SceneColor_float((float4(_Add_FCAE1710_Out_2, 0.0, 1.0)), _SceneColor_E03F9940_Out_1);
                ...
                Unity_Multiply_float((_Lerp_B4C04BFD_Out_3.xyz), _SceneColor_E03F9940_Out_1, _Multiply_D633B72E_Out_2);
                float _Property_65F05FC9_Out_0 = _WaterAlphaMultiply;
                float _Multiply_A5FC51AA_Out_2;
                Unity_Multiply_float(_Subtract_331D19CE_Out_2, _Property_65F05FC9_Out_0, _Multiply_A5FC51AA_Out_2);
                float _Clamp_F836115D_Out_3;
                Unity_Clamp_float(_Multiply_A5FC51AA_Out_2, 0, 1, _Clamp_F836115D_Out_3);
                float _Property_B1F4794D_Out_0 = _WaterAlphaPower;
                float _Power_86B6296_Out_2;
                Unity_Power_float(_Clamp_F836115D_Out_3, _Property_B1F4794D_Out_0, _Power_86B6296_Out_2);
                float _Clamp_DB0CE029_Out_3;
                Unity_Clamp_float(_Power_86B6296_Out_2, 0, 1, _Clamp_DB0CE029_Out_3);
                float3 _Lerp_E9A0ECDE_Out_3;
                Unity_Lerp_float3(_Multiply_D633B72E_Out_2, (_Lerp_B4C04BFD_Out_3.xyz), (_Clamp_DB0CE029_Out_3.xxx), _Lerp_E9A0ECDE_Out_3);
                ...
                float3 _Lerp_5E1F7829_Out_3;
                Unity_Lerp_float3(_SceneColor_E03F9940_Out_1, _Lerp_E9A0ECDE_Out_3, (_Clamp_9B4149BD_Out_3.xxx), _Lerp_5E1F7829_Out_3);
                ...
                Unity_Lerp_float3(_Lerp_5E1F7829_Out_3, _Property_71824DF9_Out_0, (_Multiply_6E6B7134_Out_2.xxx), _Lerp_6998DF58_Out_3);
                ...
                float _Blend_EE49C292_Out_2;
                Unity_Blend_Overwrite_float(_SampleTexture2D_B8ACE3F1_A_7, _SampleTexture2D_A1621BBD_A_7, _Blend_EE49C292_Out_2, _Absolute_D56AD49D_Out_1);
                ...
                float _Fraction_12A5FB28_Out_1;
                Unity_Fraction_float(_Add_7EF542FE_Out_2, _Fraction_12A5FB28_Out_1);
                float2 _Multiply_39A54641_Out_2;
                Unity_Multiply_float(_Branch_EDA2C0E3_Out_3, (_Fraction_12A5FB28_Out_1.xx), _Multiply_39A54641_Out_2);
                ...
                float _Fraction_9E406053_Out_1;
                Unity_Fraction_float(_Add_42A4AEEC_Out_2, _Fraction_9E406053_Out_1);
                float2 _Multiply_EEA6AA5B_Out_2;
                Unity_Multiply_float(_Branch_EDA2C0E3_Out_3, (_Fraction_9E406053_Out_1.xx), _Multiply_EEA6AA5B_Out_2);
                ...
                Unity_Lerp_float(0, _Blend_EE49C292_Out_2, _Clamp_805729EB_Out_3, _Lerp_39572874_Out_3);
                ...
                Unity_Absolute_float(_Blend_EE49C292_Out_2, _Absolute_5DF2B9D0_Out_1);
                ...
                float _Blend_56841A01_Out_2;
                Unity_Blend_Overwrite_float(_SampleTexture2D_387AEB22_A_7, _SampleTexture2D_9FEF114B_A_7, _Blend_56841A01_Out_2, _Absolute_19D4C5A5_Out_1);
                float _Multiply_2D163AB3_Out_2;
                Unity_Multiply_float(0.5, _Blend_56841A01_Out_2, _Multiply_2D163AB3_Out_2);
                ...
                Unity_Lerp_float(_Multiply_2D163AB3_Out_2, _Blend_56841A01_Out_2, _Clamp_1E99CDDE_Out_3, _Lerp_50210667_Out_3);
                ...
                Unity_Absolute_float(_Blend_56841A01_Out_2, _Absolute_E807A97_Out_1);
                ...
                Unity_Lerp_float3(_Lerp_96C773B7_Out_3, _Lerp_5E1F7829_Out_3, (_Split_42E433A0_R_1.xxx), _Lerp_8DC18263_Out_3);
                float3 _Lerp_39AFE3C2_Out_3;
                Unity_Lerp_float3(_Lerp_5E1F7829_Out_3, _Multiply_E85EE897_Out_2, (_Clamp_33692D9C_Out_3.xxx), _Lerp_39AFE3C2_Out_3);
                ...
                Unity_Lerp_float3(_Lerp_5E1F7829_Out_3, _Multiply_630AB59_Out_2, (_Clamp_142C06F9_Out_3.xxx), _Lerp_8E1AA6D9_Out_3);
                ...
                float _Property_399CF5F0_Out_0 = _OutlinePower;
                float _OneMinus_F19BF3EF_Out_1;
                Unity_OneMinus_float(_Property_399CF5F0_Out_0, _OneMinus_F19BF3EF_Out_1);
                float _Add_53102B82_Out_2;
                Unity_Add_float(_Subtract_331D19CE_Out_2, _OneMinus_F19BF3EF_Out_1, _Add_53102B82_Out_2);
                float _Absolute_8CE6A8BB_Out_1;
                Unity_Absolute_float(_Add_53102B82_Out_2, _Absolute_8CE6A8BB_Out_1);
                float _Property_BCFC6E6B_Out_0 = _OutlineFalloffBorder;
                float _OneMinus_D4C2721A_Out_1;
                Unity_OneMinus_float(_Property_BCFC6E6B_Out_0, _OneMinus_D4C2721A_Out_1);
                float _Power_DC867686_Out_2;
                Unity_Power_float(_Absolute_8CE6A8BB_Out_1, _OneMinus_D4C2721A_Out_1, _Power_DC867686_Out_2);
                float _Clamp_A6F1C350_Out_3;
                Unity_Clamp_float(_Power_DC867686_Out_2, 0, 1, _Clamp_A6F1C350_Out_3);
                float4 _Property_C59730BD_Out_0 = _Outline_Color;
                float4 _Multiply_54E8D4E2_Out_2;
                Unity_Multiply_float((_Clamp_A6F1C350_Out_3.xxxx), _Property_C59730BD_Out_0, _Multiply_54E8D4E2_Out_2);
                float4 _Multiply_8996C25F_Out_2;
                Unity_Multiply_float(_Multiply_54E8D4E2_Out_2, (_Split_42E433A0_A_4.xxxx), _Multiply_8996C25F_Out_2);
                float _Property_E60687FC_Out_0 = _WaterSpecularFar;
                float _Property_3CA71885_Out_0 = _WaterSpecularClose;
                float _Absolute_5D99FB53_Out_1;
                Unity_Absolute_float(_Clamp_FA371D5_Out_3, _Absolute_5D99FB53_Out_1);
                float _Property_DA074F44_Out_0 = _WaterSpecularThreshold;
                float _Power_12CD8AA2_Out_2;
                Unity_Power_float(_Absolute_5D99FB53_Out_1, _Property_DA074F44_Out_0, _Power_12CD8AA2_Out_2);
                float _Lerp_587F9C95_Out_3;
                Unity_Lerp_float(_Property_E60687FC_Out_0, _Property_3CA71885_Out_0, _Power_12CD8AA2_Out_2, _Lerp_587F9C95_Out_3);
                float _Property_F9333C36_Out_0 = _FoamSpecular;
                float _Lerp_A255FC9C_Out_3;
                Unity_Lerp_float(_Lerp_587F9C95_Out_3, _Property_F9333C36_Out_0, _Multiply_6E6B7134_Out_2, _Lerp_A255FC9C_Out_3);
                float _Property_6BDB080B_Out_0 = _SmallCascadeSpecular;
                float _Lerp_AEACE46_Out_3;
                Unity_Lerp_float(_Lerp_A255FC9C_Out_3, _Property_6BDB080B_Out_0, _Lerp_8877E3D4_Out_3, _Lerp_AEACE46_Out_3);
                float _Property_6E266398_Out_0 = _BigCascadeSpecular;
                float _Lerp_F3DF7AB7_Out_3;
                Unity_Lerp_float(_Lerp_AEACE46_Out_3, _Property_6E266398_Out_0, _Lerp_6316FED8_Out_3, _Lerp_F3DF7AB7_Out_3);
                float _Lerp_9144D527_Out_3;
                Unity_Lerp_float(_Lerp_F3DF7AB7_Out_3, _Lerp_587F9C95_Out_3, _Split_42E433A0_R_1, _Lerp_9144D527_Out_3);
                float _Lerp_7CE633F3_Out_3;
                Unity_Lerp_float(_Lerp_587F9C95_Out_3, _Property_6BDB080B_Out_0, _Clamp_33692D9C_Out_3, _Lerp_7CE633F3_Out_3);
                float _Lerp_1F50472D_Out_3;
                Unity_Lerp_float(_Lerp_9144D527_Out_3, _Lerp_7CE633F3_Out_3, _Split_42E433A0_G_2, _Lerp_1F50472D_Out_3);
                float _Lerp_BABAE680_Out_3;
                Unity_Lerp_float(_Lerp_587F9C95_Out_3, _Property_6E266398_Out_0, _Clamp_142C06F9_Out_3, _Lerp_BABAE680_Out_3);
                float _Lerp_863BBF65_Out_3;
                Unity_Lerp_float(_Lerp_1F50472D_Out_3, _Lerp_BABAE680_Out_3, _Split_42E433A0_B_3, _Lerp_863BBF65_Out_3);
                ...
                float _Property_555E54FF_Out_0 = _EdgeFalloffMultiply;
                float _Multiply_9826B249_Out_2;
                Unity_Multiply_float(_Subtract_331D19CE_Out_2, _Property_555E54FF_Out_0, _Multiply_9826B249_Out_2);
                float _Clamp_343DD181_Out_3;
                Unity_Clamp_float(_Multiply_9826B249_Out_2, 0, 1, _Clamp_343DD181_Out_3);
                float _Absolute_7B305AA4_Out_1;
                Unity_Absolute_float(_Clamp_343DD181_Out_3, _Absolute_7B305AA4_Out_1);
                float _Property_B3679B96_Out_0 = _EdgeFalloffPower;
                float _Power_3025A080_Out_2;
                Unity_Power_float(_Absolute_7B305AA4_Out_1, _Property_B3679B96_Out_0, _Power_3025A080_Out_2);
                float _Clamp_FF21A8F_Out_3;
                Unity_Clamp_float(_Power_3025A080_Out_2, 0, 1, _Clamp_FF21A8F_Out_3);
                float _Multiply_73E319C1_Out_2;
                Unity_Multiply_float(_Clamp_FF21A8F_Out_3, _Split_42E433A0_A_4, _Multiply_73E319C1_Out_2);
                ...
                surface.Specular = (_Lerp_863BBF65_Out_3.xxx);
            ...
            PackedVaryings PackVaryings(Varyings input)
            {
                ...
                output.interp07.xyz = input.bitangentWS;
                #if defined(LIGHTMAP_ON)
            ...
            Varyings UnpackVaryings(PackedVaryings input)
            {
                ...
                output.bitangentWS = input.interp07.xyz;
                #if defined(LIGHTMAP_ON)
